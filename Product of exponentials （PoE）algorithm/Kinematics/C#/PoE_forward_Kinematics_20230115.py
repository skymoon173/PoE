...
def MZ07_Trajectory_Planning_StraightLine_TrapezoidalMotion_Parameter_a_T(θ1_origin, θ2_origin,θ3_origin,θ4_origin,θ5_origin,θ6_origin,θ1_target, θ2_target,θ3_target,θ4_target,θ5_target,θ6_target,a = 10, T =1,t=0.0001):
	...
	plt.plot(x_axis,V)
	plt.show()
def MZ07_Trajectory_Planning_StraightLine_Polynomial_AngleOutput(θ1_origin, θ2_origin,θ3_origin,θ4_origin,θ5_origin,θ6_origin,θ1_target, θ2_target,θ3_target,θ4_target,θ5_target,θ6_target,T=3,t=0.01,steps=10,error=0.001):
	a0 = 0 
	a1 = 0
	a2 = 3/(T*T)
	a3 = -2/(T*T*T)
...
a = MZ07_Trajectory_Planning_StraightLine_Polynomial_AngleOutput(10,20,30,40,50,60,60,50,40,30,20,10,T=3,t=0.01,steps=100,error=0.001)
print(a)
