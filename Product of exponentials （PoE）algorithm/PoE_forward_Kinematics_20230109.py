...
#MZ07_Numerical_Inverse_Kinematics_PoEModel(561.6031086904793, 96.79060381411189, 34.91359270253432, -12.718287925248825, -28.49299635270986, 9.45823575817574 ,steps = 100,error = 0.1,theta0_1=45,theta0_2=36,theta0_3=32,theta0_4=26,theta0_5=37,theta0_6=24)

def MZ07_Trajectory_Planning_StraightLine_Polynomial(θ1_origin, θ2_origin,θ3_origin,θ4_origin,θ5_origin,θ6_origin,θ1_target, θ2_target,θ3_target,θ4_target,θ5_target,θ6_target,T=3,t=0.01):
	a0 = 0 
	a1 = 0
	a2 = 3/(T*T)
	a3 = -2/(T*T*T)
	...
	plta = plt.gca(projection='3d')
	plta.plot(px, py, pz)
	plta.plot(x_axis,v,40)
	plt.show()

def MZ07_Trajectory_Planning_StraightLine_TrapezoidalMotion(θ1_origin, θ2_origin,θ3_origin,θ4_origin,θ5_origin,θ6_origin,θ1_target, θ2_target,θ3_target,θ4_target,θ5_target,θ6_target,v = 100, T=15,t=0.01):
	...
	plta.plot(x_axis,V,40)
	plt.show()
MZ07_Trajectory_Planning_StraightLine_TrapezoidalMotion(10,10,10,10,10,10,11,11,11,11,11,11,v = 40, T=3,t=0.01)